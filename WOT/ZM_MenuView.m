...
-(void)setMenueWithArray:(NSArray *)nameArray
{
    ...
    for (int i=0; i<nameArray.count; i++) {
        ...
        [enable addAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f],NSForegroundColorAttributeName:[UIColor whiteColor]} range:NSMakeRange(0, enable.length)];
        ...
        [unEnable addAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f],NSForegroundColorAttributeName:[UIColor redColor]} range:NSMakeRange(0, unEnable.length)];
